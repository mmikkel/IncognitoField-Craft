 ...
 *
 * A PlainText FieldType which can be disabled or hidden.
 *
 * --snip--
...
class IncognitoFieldPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('A PlainText FieldType which can be disabled or hidden.');
    }
    ...
    {
        return 'https://github.com/mmikkel/IncognitoField-Craft/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/mmikkel/IncognitoField-Craft/master/releases.json';
    }
